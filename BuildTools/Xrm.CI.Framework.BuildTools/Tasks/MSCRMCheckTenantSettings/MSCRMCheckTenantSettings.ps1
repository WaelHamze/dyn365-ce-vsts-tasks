...
Write-Verbose 'Entering MSCRMCheckTenantSettings.ps1'
...
& "$mscrmToolsPath\xRMCIFramework\9.0.0\CheckTenantSettings.ps1" -TenantId $TenantId -ApplicationId $ApplicationId -ApplicationSecret $ClientSecret -TenantSettingsFile $settingsConfigFile -PowerAppsAdminModulePath $powerAppsAdminPath
