...
New-Item "$OutputDir\Tasks\$taskName\Lib\Nuget\4.9.4" -ItemType directory | Out-Null
Copy-Item -Path .\Lib\Nuget\4.9.4\*.* -Destination "$OutputDir\Tasks\$taskName\Lib\Nuget\4.9.4"
