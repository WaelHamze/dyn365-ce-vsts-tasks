...
Download-NugetPackage -packageName 'Microsoft.CrmSdk.CoreTools' -version '9.1.0.38' -folderName 'CoreTools' -packagePath 'content\bin\coretools'

# Download PowerShell Modules
Download-PSModule -moduleName 'AzureAD' -version '2.0.2.52' -folderName 'AAD'
Download-PSModule -moduleName 'Microsoft.Xrm.Tooling.CrmConnector.PowerShell' -version '3.3.0.886' -folderName 'CrmConnector.PowerShell'
Download-PSModule -moduleName 'Microsoft.Xrm.Tooling.PackageDeployment.Powershell' -version '3.3.0.879' -folderName 'PackageDeployment.Powershell'
...
Download-PSModule -moduleName 'Microsoft.Xrm.Tooling.ConfigurationMigration' -version '1.0.0.26' -folderName 'ConfigurationMigration.Powershell'
